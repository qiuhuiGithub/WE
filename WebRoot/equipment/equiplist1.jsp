...
<!-- <table class="table table-bordered"> -->
		<tr>
			<th colspan="19" align="center">所有设备</th>
		</tr>
		<tr>
		    <th>领用单位号</th>
			<th>单位名称</th>
...
<a href="equiplist.action?pageNumber=1&id=1">首页</a>&nbsp;&nbsp;
<a href="equiplist.action?pageNumber=${pageNumber-1}&id=1">上一页</a>&nbsp;&nbsp;
<a href="equiplist.action?pageNumber=${pageNumber+1}&id=1">下一页</a>&nbsp;&nbsp;
<a href="equiplist.action?pageNumber=${totalPage}&id=1">末页</a>&nbsp;&nbsp;
	 </td></tr></table>
