...
<html>
  <head>
    ...
    <title>My JSP 'querybyuser.jsp' starting page</title>
  ...
  <h1 align ="center">设备查询页面</h1> 
   <form action="querybyuser.action" method="post">
   <table>
   ...
   </td><td><input type="submit" name="submit" value="提交"></td>
   </tr>
