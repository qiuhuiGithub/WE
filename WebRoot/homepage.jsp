    ...
    <td><table width="1002"   align="center"  height="71">
        <tr>
          ...
          <td><a href="login.jsp"><img src="image/admin.jpg" /></a></td>
            <td><a href="login.jsp"><img src="image/date.jpg" /></a></td>
              <td><a href="login.jsp"><img src="image/user.jpg" /></a></td>
          <td ><select style="FONT-SIZE: 9pt;color:#000000; WIDTH: 180px;  margin:4px 0 0 2px;" onChange="window.open(this.options[this.selectedIndex].value,'_Blank')" size=1 name=select1>
              ...
              <option value = "http://www.hit.edu.cn" target=_blank style="color:#535353"> 百度一下，你就知道</a></option>
              ...
              <option value = "http://www.miit.gov.cn/" target=_blank style="color:#535353"> 搜狐视频</a></option>
              
              <option value = "http://lamd.hrbeu.edu.cn/" target=_blank style="color:#535353"> 网易邮箱</a></option>
              
              <option value = "http://asset.buaa.edu.cn/" target=_blank style="color:#535353"> 腾讯首页</a></option>
              
              <option value = "http://www.nwpu.edu.cn/guozichu/" target=_blank style="color:#535353"> 腾讯游戏</a></option>
              
              <option value = "http://gzc.nuaa.edu.cn/" target=_blank style="color:#535353"> 腾讯QQ</a></option>
              
              <option value = "http://www.bit.edu.cn/xxgk/gljg/xzjg/" target=_blank style="color:#535353"> 腾讯空间</a></option>
              
              <option value = "http://www.njust.edu.cn/" target=_blank style="color:#535353"> 腾讯娱乐</a></option>
