...
<p><a href="javascript: d.openAll();">全部打开</a> | <a href="javascript: d.closeAll();">全部关闭</a></p>
	...
	//	d.add(6,40,'按价格','left.jsp',"","right");
		...
		d.add(45,3,'所有文档','paperlist.action?id=0',"","right");
		d.add(41,3,'合同','paperlist.action?id=1',"","right");
		d.add(42,3,'使用手册','paperlist.action?id=2',"","right");
		d.add(43,3,'设计手册','paperlist.action?id=3',"","right");
		d.add(44,3,'其它文档','paperlist.action?id=4',"","right");
		document.write(d);
		</script>
</div>
  </body>
