		...
		public String execute(){
			...
			try{
				String sql1="update equipment set unitno="+"'"+unitno+"',"+"unitname='"+unitname+"',"+"name='"+name+"'"+","+"model="+"'"+model+"'"+","+"spec="
						...
						+vender+"',"+"serialnumber="+"'"+serialnumber+"',"+"buydate="+"'"+buydate+"',"+"outdate="+"'"+outdate+"',"+"useman="+"'"+useman+"',"+"researchno="+"'"+researchno+"',"+"brokerman="+"'"+brokerman+"',"+"partment="+"'"+partment+"',"+"location="+"'"+location+"',"+"status="+"'"+status+"'"+" "+"where ID="+ID;
