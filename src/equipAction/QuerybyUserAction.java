...
public class QuerybyUserAction extends ActionSupport {
		...
		public String execute(){
			...
			try{
				String sql3="select partment from user where username="+"'"+user+"'";
				stmt3=conn.createStatement();
				ResultSet result3=stmt3.executeQuery(sql3);
				if(result3.next()){
					part=result3.getString(1);
				}
				System.out.println(part);
				if(ID!=null){
				String sql="select * from equipment where ID='"+ID+"'"+"and partment='"+part+"'";
				...
				if(result.next()){
					...
					Equipment.setPartment(result.getString(15));
					Equipment.setLocation(result.getString(16));
					Equipment.setStatus(result.getString(17));
					ret=SUCCESS;
				}
			}
				if(name!=null){
					String sql1="select * from equipment where name='"+name+"'"+"and partment='"+part+"'";
					...
					while(result1.next()){
						...
						tmp.setPartment(result1.getString(15));
						tmp.setLocation(result1.getString(16));
						tmp.setStatus(result1.getString(17));
						namelist.add(tmp);
						ret="name";
					}
					namelist.toArray();
			...
			if(vender!=null){
				String sql2="select * from equipment where vender='"+vender+"'"+"and partment='"+part+"'";
				...
				while(result2.next()){
					...
					tmp1.setPartment(result2.getString(15));
					tmp1.setLocation(result2.getString(16));
					tmp1.setStatus(result2.getString(17));
					venderlist.add(tmp1);
					ret="vender";
				}
				venderlist.toArray();
