	...
	try{
		...
		ret="success";
			...
			while(result1.next()){
				...
				tmp1.setIsadmin(result1.getInt(6));
				tmp1.setIsedit(result1.getInt(7));
				tmp1.setIsuser(result1.getInt(8));
				editlist.add(tmp1);
				ret="edit";
			 }
			editlist.toArray();
			...
			while(result2.next()){
				...
				tmp2.setIsadmin(result2.getInt(6));
				tmp2.setIsedit(result2.getInt(7));
				tmp2.setIsuser(result2.getInt(8));
				userlist.add(tmp2);
				ret="user";
			}
			userlist.toArray();
